...
public class PanelAgents extends JPanel {
    ...
    public PanelAgents() {
        ...
        btnSupprimer.addActionListener(e -> {
            ...
            if (selectedRow == -1) {
                JOptionPane.showMessageDialog(this, "Sélectionnez un agent à supprimer", "Erreur",
            ...
            int confirm = JOptionPane.showConfirmDialog(this, "Êtes-vous sûr de vouloir supprimer cet agent ?",
                    "Confirmation", JOptionPane.YES_NO_OPTION);
            if (confirm == JOptionPane.YES_OPTION) {
                if (agentDAO.deleteAgent(numero)) {
                    refreshData();
                    JOptionPane.showMessageDialog(this, "Agent supprimé avec succès", "Succès",
    ...
    private void showAddAgentDialog() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            if (agentDAO.addAgent(agent)) {
                refreshData();
                JOptionPane.showMessageDialog(this, "Agent ajouté avec succès", "Succès",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Erreur lors de l'ajout de l'agent", "Erreur",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
